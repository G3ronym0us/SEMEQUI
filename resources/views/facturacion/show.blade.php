...
<body>
    <center><h1>FACTURA</h1></center><br>
    ...
    <table class="" id="datos_empresa">
        <tr class="" >
            ...
            <td style="width: 120px;" class="text-center">Factura</td>
        </tr>
        <tr class="">
        ...
        <tr class="">
            ...
            <td class="text-center border-top">{{ substr($factura->cod_factura,6) }}</td>
        </tr>
        <tr class="">
    ...
    <span>NOMBRE CLIENTE: {{$factura->nom_cliente}}</span><br>
    <span>NIT /CC: {{$factura->nit_cliente}}</span><br>
    <span>DIRECCION: {{$factura->dir_cliente}}</span><br>
    <span>UBICACION: {{$factura->nom_departamento.' - '.$factura->nom_municipio}}</span><br>
    <span>TEL. CELULAR: {{$factura->tel_cliente}}</span><br>
    <span>CORREO: {{$factura->correo_cliente}}</span><br><br><br>
    ...
    <footer>
        <table class="bordered">
            <tr>
                ...
                <td class="bordered text-left w-80">{{ $factura->forma_pago }}</td>
            </tr>
            <tr>
                <th class="bordered text-left w-20">OBSERVACION</th>
                <td class="bordered text-left w-80">{{ $factura->observacion }}</td>
            </tr>
        </table>       
    </footer>
