 			...
 			<div class="modal-header">
  			...
  			<div class="modal-body">
				<div class="row">
			    	...
			    	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
			    		<span class="text-danger">*</span><label>NONBRE</label>
			    	...
			    	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
			    		...
			    		<input type="text" name="caracteristica_equipo" class="form-control bg-info text-white" value="{{ $cl->caracteristica_equipo }}" onkeyup="mayusculas(this);" >
			    	</div>

			    	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
			    		<label>OBSERVACION</label>
			    		<input type="text" name="obs_equipo" class="form-control bg-info text-white" value="{{ $cl->obs_equipo }}" onkeyup="mayusculas(this);">
			    	</div>
			    	<div class="col-lg-12 col-md-12  col-sm-12 col-xs-12 form-group">
