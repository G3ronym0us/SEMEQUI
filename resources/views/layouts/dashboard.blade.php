...
<div class="container">
	<div class="row">
		<div class="col-4 card text-white bg-warning mb-3" style="max-width: 30%;">
		  <div class="card-body">
		  	<div class="row">
		  		<div class="col-3">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<div class="col-4 card text-white mb-3" style="max-width: 30%; background-color: #76448A;">
		  <div class="card-body">
		  	<div class="row">
		  		<div class="col-3">
		  		...
		  		<div class="col-9">
				    ...
				    <div class="progress" style="height: 5px;">
						<div class="progress-bar progress-bar-striped bg-danger" role="progressbar" style="width: {{ $porcentaje_ventas }}%; height: 5px;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
					</div>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<div class=" col-4 card text-white mb-3" style="max-width: 30%; background-color: #117A65;">
		  <div class="card-body">
		  	<div class="row">
		  		<div class="col-3">
		  		...
		  		<div class="col-9">
				    ...
				    <div class="progress" style="height: 5px;">
						<div class="progress-bar progress-bar-striped bg-danger" role="progressbar" style="width: {{ $porcentaje_clientes }}%; height: 5px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
					</div>
